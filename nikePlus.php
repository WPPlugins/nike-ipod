...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
	...
	$serverversion = @file_get_contents('http://www.ear-fung.us/_nikePlusVer.txt?myversion='.$myversion);
	if(!empty($serverversion) && $myversion != $serverversion)
	{
		echo '<p align="center" style="color:black;background-color:#FF6666;padding:5px;">There is a new version of the NikePlus plugin. <a href="http://www.ear-fung.us/apps/nikeplus/">Please click here to download it.</a> (You have version '.$myversion.', the new version is '.$serverversion.')</p>';
	}
